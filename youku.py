...
class Youku():
    ...
    def __init__(self):
        ...
        self.utid =pathname2url('/BYpE8JTKjkCAWXmx6LC8rxi')
        print(self.utid)
            ...
            if 'error' in res_json['data']:
                ...
                if str(error['code']) == '-6004':
                    ...
                    if retry == 0:
                        ...
                        self.utid = url2pathname(self.utid)
...
if __name__ == '__main__':
    ...
    url_input = 'https://v.youku.com/v_show/id_XNDUyNjg3OTQyOA==.html?spm=a2hbt.13141534.1_3.d1_4'
    youku = Youku()
